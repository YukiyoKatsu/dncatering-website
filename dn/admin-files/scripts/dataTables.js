...
// Add event listener to parent element and use event delegation
document.querySelector("tbody").addEventListener("click", function(event) {
	if (event.target.classList.contains("showButton")) {
		event.target.nextElementSibling.style.display = "block";
		event.target.style.display = "none";
	} else if (event.target.classList.contains("hideButton")) {
...
document.addEventListener('DOMContentLoaded', function () {
            var showDialogButtons = document.querySelectorAll('.showOtherDetails');
            ...
            var closeDialogButtons = document.querySelectorAll('.closeDialog');
            closeDialogButtons.forEach(function(button) {
                button.addEventListener('click', function () {
                    var dialog = this.closest('.otherDetailsDialog');
                    dialog.close();
                });
            });
        });
...
function myFunction(button) {
	var uploadFiles = button.closest('.dataTitle').querySelector('.uploadFiles');
	var btnText = button.textContent;

	if (uploadFiles.style.display === "none" || uploadFiles.style.display === "") {
