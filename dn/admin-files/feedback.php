...
<head>
    ...
    <title id="headTitle" class="headTitle">Admin DN | Customer's Feedback</title>
    ...
    <link rel="stylesheet" href="styles\feedback-table-noarrow.css">
</head>
<body>
    <nav class="leftnavbar">
        <a href="../index.php" target="_blank"><img src="pictures\logo.png" alt="" title="Click here to go to User Page."></a>
        <ul class="nav-list">
            <li class="active">
    ...
    <main>
        ...
        <h1 class="pagetitle">Customer's Feedback</h1>
        
        <table id="myTable" class="display">
            <thead> 
                <tr>
                    <th class="dataTitle" style="width: 15%;">Date<p class="date">(YY-MM-DD)</p></th>
                    <th class="dataTitle" style="width: 5%;">Rate</th>
                    <th class="dataTitle" style="width: 20%;">Name</th>
                    <th class="dataTitle" style="width: 65%;">Feedback</th>
                    <th class="dataTitle" style="width: 5%;">Action</th>
                    <th class="dataTitle" style="width: 5%;">Delete</th>
                </tr>
            </thead>
            <tbody>
            <?php
            include("php/feedback-table.php");
            ?>
            </tbody>
        </table>
    </main>
