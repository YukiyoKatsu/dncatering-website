...
function redirectToFormalQuote(eventIndex, packageIndex) {
    // Pass parameters via query string
    window.location.href = 'formal-quote.php?eventIndex=' + eventIndex + '&packageIndex=' + packageIndex + '#formalQuote_container';
}